...
<style type="text/css">
    /* .bgimg {
        background-image: url('<?=base_url()?>/picture/background2.png');
            ...
            <div class="card-body">
                <div class="container">
                    <div class="d-sm-flex align-items-center justify-content-between">
                        ...
                        <img src="<?=base_url()?>/picture/background2.png" alt="satu data" class="img-fluid ">
                    </div>
                </div>
            </div>
        </div>
            ...
            <div class="row">
                <div class="col">
                    ...
                    <table class="table table-bordered mt-5" id="kelompok_tani">
                        ...
                        <?php $i = 1; ?>
                        <tbody>
                            <?php foreach ($data['kelompokTani'] as $entity) : ?>
                                <tr>
                                    <td class="text-center"><?= $i++; ?></td>
